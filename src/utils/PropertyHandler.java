...
public class PropertyHandler extends Properties {
    ...
    private File getPropertyFile(String propertyFileString)
        ...
        // @Grader - Added this code to poperly handle property files names, resolves bug where file exists but is not recognized.
        String propertyFileName = System.getProperty("user.dir") + "/appserver/satellite/" +propertyFileString;
        if ((propertyFile = new File(propertyFileName)).exists()) {
            return propertyFile;
        } else {
            System.out.print(propertyFileName);
            System.out.println(" I don't see this file. Sorry.");
        }
